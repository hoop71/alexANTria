---
title: ANT-SCHEMA - Documentation Hierarchy Pattern
description: Knowledge spectrum from code-inferable to human-required. Maps RLM three-pool architecture to five organizational layers.
---
